  ...
  $org_query = $conn->query("SELECT * FROM organizer WHERE password='$org_password' AND access='Organizer'");
     ...
     $active_sub_event=$org_row['active_sub_event'];
      ...
      <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
            ...
            swal.fire({
                          icon: "success", 
                          title: "Tabulator <?php echo $fname; ?> ",
                          text: "successfully added...",
                          showConfirmButton: false,
                          timer: 2000
            }).then( function() { window.location = "edit_tabulator.php";});</script> 
        <?php }else{ ?>	
      <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
            <script>
            ...
            swal.fire({
                          ...
                          text: "Pls. contact event organizer.",
                          showConfirmButton: false,
                          timer: 2000
            }).then( function() { window.location = "edit_tabulator.php";});</script> 
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
            ...
            swal.fire({
                          icon: "error", 
                          title: "Tabulator <?php echo $fname." ".$mname." ".$lname; ?> registration cannot be done.",
