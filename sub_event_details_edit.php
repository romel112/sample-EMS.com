...
<div id="myGroup"> 
     ...
     <div style="border: 0px;" class="accordion-group">
                ...
                <section id="download-bootstrap">
                    ...
                    <h1 style="color:blue;">Contestant's Settings 
                ...
                <div class="collapse indent" id="judges">
                    <section id="download-bootstrap">
          <div class="page-header">
            <h1 style="color:blue;">Judge's Settings  
 ...
 <td colspan="6">
  ...
  <button title="Click to delete selected row(s)" type="submit" class="btn btn-danger" name="delete_judge" ><i class="icon icon-trash"></i></button> 
                ...
                <section id="download-bootstrap">
          <div class="page-header">
            <h1 style="color:blue;">Criteria's Settings &nbsp;<a title="Click to add new Criteria for this Event" href="add_criteria.php?sub_event_id=<?php echo $sub_event_id; ?>&se_name=<?php echo $se_name;?>" class="btn btn-primary"><i class="icon icon-plus"></i></a></h1>
          </div>
   <table class="table table-bordered" style="background-color:white;">
  <thead>
  <th>Check to Select</th>
 ...
 <button title="Click to delete selected row(s)" type="submit" class="btn btn-danger" name="delete_crit" ><i class="icon icon-trash"></i></button>  
                ...
                <div class="collapse indent" id="textpoll">
                 <section id="download-bootstrap">
          <div class="page-header">
            <h1 style="color:blue;">Text Poll Settings</h1>
          </div>
  <?php
...
$tp_status=$_POST['tp_status'];
 ...
 ?>
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
            ...
            swal.fire({
                          icon: "success", 
                          title: "Textpoll Deactivated",
                          text: "Successfully.",
                          showConfirmButton: false,
                          timer: 2000
            }).then( function() { window.location = "sub_event_details_edit.php?sub_event_id=<?php echo $sub_event_id;?>&se_name=<?php echo $se_name;?>";});</script> 
    <?php 
 }
...
<script>
            swal(" Contestant(s)", "successfully deleted.", "error").then( function() { 
...
<script>
            swal(" Confirmation", " password is invalid!", "error").then( function() { 
              window.location = "sub_event_details_edit.php?sub_event_id=<?php echo $sub_event_id;?>&se_name=<?php echo $se_name;?>";});
            </script>
    <?php
} }
...
<script>
            swal(" Contestant(s)", "  successfully deleted.", "success").then( function() { 
              window.location = "sub_event_details_edit.php?sub_event_id=<?php echo $sub_event_id;?>&se_name=<?php echo $se_name;?>";});
            </script>
...
<script>
            swal(" Criteria(s)", "  successfully deleted.", "success").then( function() { 
              window.location = "sub_event_details_edit.php?sub_event_id=<?php echo $sub_event_id;?>&se_name=<?php echo $se_name;?>";});
            </script>
    <?php
}
