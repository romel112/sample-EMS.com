   ...
   $s_event_query = $conn->query("select * from sub_event where mainevent_id='$active_main_event'") or die(mysql_error());
        ...
        <tr>
            ...
            <h3><?php echo $s_event_row['event_name']; ?></h3> 
              ...
              <div class="pull-right"><button onClick="window.print()" style="background-color:#05004ed1; padding:7px; border-radius:5px; font-size:20px; color:white;">Print</button></div>
             </table>
