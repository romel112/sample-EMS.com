        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            ...
            <li>
              ...
              <li  class="active">
                <a href="score_sheets.php"><strong><img src="https://img.icons8.com/color/40/000000/moleskine.png"/>Score Sheets</a></strong>
              </li>
...
$MEidxxx=$sy_row['mainevent_id'];
        ...
        { ?>
         ...
         <div class="panel table-responsive" style= "border-radius:5px;">
         ...
         <table class="m-auto table table-striped table-hover ">
          ...
          <thead>
            <tr>
                ...
                <th scope="col">View Score Sheet - Select Judge</th>
     ...
     <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><strong><?php echo $s_event_row['event_name']; ?></strong> <span class="caret"></span></a>
                  ...
                  <li>
                  <a title="Go to live viewing of this Sub-Event Text Poll." target="_blank" href="view_txtpoll.php?sid=<?php echo $se_id; ?>">Text Poll Live View</a> 
                  </li>
     ...
     <a style="margin-top: 4px !important;" title="click to rank contestant score's for this judge" target="_blank" href="view_score_sheet.php?event_id=<?php echo $se_id ; ?>&judge_id=<?php echo $judge_row['judge_id']; ?>" class="btn btn-info"> <?php echo $judge_row['judge_ctr']; ?>. <?php echo $judge_row['fullname']; ?></a>
      <?php } ?>
 
     </td>
     
     <td>
        <a title="click to set points deductions" target="_blank" href="deductScores.php?event_id=<?php echo $se_id ; ?>" class="btn btn-danger">Deduction</a>

        <a title="click to set final result for this sub-event" target="_blank" href="result_title.php?event_id=<?php echo $se_id ; ?>" class="btn btn-primary">Final Result</a>
        
        <a title="click to print results" target="_blank" href="result_sheet.php?event_id=<?php echo $se_id ; ?>" class="btn btn-primary">Print</a>
