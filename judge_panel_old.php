        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#"><img src="uploads/<?php echo $company_logo; ?>" width="23" height="23" />&nbsp; <font size="3">Event Management System</font></a>
                   ...
                   <a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=allTally">View Tally</a>  
                     <?php  } 
                                        ...
                                        <div class="container">
                                          ...
                                          <font size="4">Event Management System &middot; 2021 &COPY;</font>
                                          <hr />
