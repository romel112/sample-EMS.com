...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
            ...
            swal.fire({
                          icon: "success", 
                          title: "Score for <?php echo $contestant_name; ?> sent to Event Tabulators ",
                          text: "Thank You!",
                          showConfirmButton: false,
                          timer: 2000
            }).then( function() {window.location = "judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $contestant_id; ?>";});</script> 
